...
class TestCaseSuccessButPriceOrDiscountWasNotChanged(TestCase['TestUpdateItemView']):
    mock__fetch_catalog_item_price_and_picture_filename__return_value: CatalogItemData
...
class TestCaseSuccessButPriceHasBeenChanged(TestCase['TestUpdateItemView']):
    ...
    catalog_item_request_data: CatalogItemRequestData
    catalog_item_picture: fastapi.UploadFile
    expected_published_event: CatalogItemPriceOrDiscountWasChangedEvent
    expected_response: ExpectedHttpResponse
    mock__file_storage_api: FileStorageApiMockType


class TestCaseSuccessButDiscountHasBeenChanged(TestCase['TestUpdateItemView']):
    mock__fetch_catalog_item_price_and_picture_filename__return_value: CatalogItemData
    catalog_item_request_data: CatalogItemRequestData
    catalog_item_picture: fastapi.UploadFile
    expected_published_event: CatalogItemPriceOrDiscountWasChangedEvent
...
def test_case_sucess_but_price_or_discount_was_not_changed() -> TestCaseSuccessButPriceOrDiscountWasNotChanged:
    mock__fetch_catalog_item_price_and_picture_filename__return_value = CatalogItemData(
        price=10,
        discount=5,
    ...
    catalog_item_request_data = CatalogItemRequestData(
        ...
        on_reorder=False,
        discount=mock__fetch_catalog_item_price_and_picture_filename__return_value.discount,
    )
    ...
    return TestCaseSuccessButPriceOrDiscountWasNotChanged(
...
@pytest.fixture(scope='session')
def test_case_success_but_discount_has_been_changed() -> TestCaseSuccessButDiscountHasBeenChanged:
    mock__fetch_catalog_item_price_and_picture_filename__return_value = CatalogItemData(
        price=10,
        picture_filename='picture_filename',
        discount=10,
    ...
    return TestCaseSuccessButDiscountHasBeenChanged(
        catalog_item_request_data=catalog_item_request_data,
        catalog_item_picture=catalog_item_picture,
        mock__fetch_catalog_item_price_and_picture_filename__return_value=(
            mock__fetch_catalog_item_price_and_picture_filename__return_value
...
class TestUpdateItemView(TestClass[update_item]):
    @patch.object(CatalogItemPriceOrDiscountWasChangedEvent, CatalogItemPriceOrDiscountWasChangedEvent.publish.__name__)
    @patch.object(view, view._update_catalog_item_in_db.__name__)
    @patch.object(view, view._fetch_catalog_item_data.__name__)
    def test_case_sucess_but_price_or_discount_was_not_changed(
        self,
        mock__fetch_catalog_item_price_and_picture_filename: Mock,
        mock__update_catalog_item_in_db: Mock,
        mock__catalog_item_price_or_discount_was_changed__publish: Mock,
        test_case_sucess_but_price_or_discount_was_not_changed: TestCaseSuccessButPriceOrDiscountWasNotChanged,
    ):
        test_case = test_case_sucess_but_price_or_discount_was_not_changed
        ...
        mock__catalog_item_price_or_discount_was_changed__publish.return_value = None
        ...
        mock__catalog_item_price_or_discount_was_changed__publish.assert_not_called()
    ...
    @patch.object(
        ...
        CatalogItemPriceOrDiscountWasChangedEvent.publish.__name__,
        autospec=True,
    )
    @patch.object(view, view._update_catalog_item_in_db.__name__)
    @patch.object(view, view._fetch_catalog_item_data.__name__)
    def test_case_success_but_price_has_been_changed(
        ...
        mock__fetch_catalog_item_price_and_picture_filename: Mock,
        mock__update_catalog_item_in_db: Mock,
        mock__catalog_item_price_or_discount_was_changed_event__publish: Mock,
        ...
        mock__catalog_item_price_or_discount_was_changed_event__publish.return_value = None
        ...
        fact_called_event: CatalogItemPriceOrDiscountWasChangedEvent = (
            mock__catalog_item_price_or_discount_was_changed_event__publish.call_args[0][0]
        )
    ...
    @patch.object(view, view._update_catalog_item_in_db.__name__)
    @patch.object(view, view._fetch_catalog_item_data.__name__)
    def test_case_success_but_discount_has_been_changed(
        self,
        mock__fetch_catalog_item_price_and_picture_filename: Mock,
        mock__update_catalog_item_in_db: Mock,
        mock__catalog_item_price_or_discount_was_changed_event__publish: Mock,
        test_case_success_but_discount_has_been_changed: TestCaseSuccessButDiscountHasBeenChanged,
    ):
        test_case = test_case_success_but_discount_has_been_changed
    ...
    def test_case_failed_due_to_integrity_error(
        ...
        mock__catalog_item_price_or_discount_was_changed_event__publish.assert_not_called()
