...
from basket.views.cqrs.event_handlers import CatalogItemPriceChangedEventHandler
...
class TestCase(_TestCase['TestCatalogItemPriceChangedEventEventHandler__handle']):
    event: CatalogItemPriceChangedEvent
...
class TestCatalogItemPriceChangedEventEventHandler__handle(TestClass[CatalogItemPriceChangedEventHandler.handle]):
    ...
    def test_case(
        ...
        CatalogItemPriceChangedEventHandler().handle(event=test_case.event)
